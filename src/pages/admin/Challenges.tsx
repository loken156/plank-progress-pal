    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-grow py-12 px-6">
        <div className="container mx-auto">
          <h1 className="text-3xl font-bold mb-8">Manage Challenges</h1>
              ...
              <Card key={challenge.id}>
                ...
                <CardContent>
                  ...
                  <div className="text-sm">
                    <p>Start: {new Date(challenge.start_date).toLocaleDateString()}</p>
                    <p>End: {new Date(challenge.end_date).toLocaleDateString()}</p>
                    <p>Type: {challenge.type}</p>
                    <p>Participants: {challenge.participants}</p>
                    <p>Status: {challenge.is_active ? 'Active' : 'Inactive'}</p>
                  </div>
                </CardContent>
